...
// /api/address/* is the canonical path; /test/address/* is kept as a backwards-compatible
// alias because shipped Flutter clients may still hit it.
foreach (['api/address', 'test/address'] as $thaiAddressPrefix) {
    Route::prefix($thaiAddressPrefix)->middleware('throttle:60,1')->group(function () {
